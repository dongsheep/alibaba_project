...
//        GatewayRuleManager.loadRules(rules);
        ...
        Set<GatewayFlowRule> rules = new HashSet<>();
        rules.add(new GatewayFlowRule("my-web-api1") // api
                .setCount(1) // 限流阈值
                .setIntervalSec(1) // 统计时间窗口
        );
        GatewayRuleManager.loadRules(rules);
    ...
    private void initCustomizedApis() {
        ...
        ApiDefinition api1 = new ApiDefinition("my-web-api1")
                .setPredicateItems(new HashSet<ApiPredicateItem>() {{
                    add(new ApiPathPredicateItem().setPattern("/my-web-test/**").setMatchStrategy(SentinelGatewayConstants.URL_MATCH_STRATEGY_PREFIX));
                }});
